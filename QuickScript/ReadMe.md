================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : QuickScript Project Overview
===============================================================================

The application wizard has created this QuickScript application for 
you.  This application not only demonstrates the basics of using the Microsoft 
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your QuickScript application.
...
QuickScript.h
    ...
    project specific headers and declares the CQuickScriptApp application class.

QuickScript.cpp
    This is the main application source file that contains the application
    class CQuickScriptApp.
...
QuickScriptDlg.h, QuickScriptDlg.cpp - the dialog
    These files contain your CQuickScriptDlg class.  This class defines
...
StdAfx.h, StdAfx.cpp
    ...
    named QuickScript.pch and a precompiled types file named StdAfx.obj.
